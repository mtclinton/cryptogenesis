...
from serialize import DataStream, get_size_of_compact_size, write_compact_size, read_compact_size
from crypto import double_sha256, hash_to_uint256
from transaction import Transaction, COIN
...
class BlockIndex:
    ...
    def __init__(self, file_num: int = 0, block_pos: int = 0, block=None):
        ...
        self.phashBlock = property(lambda self: self.block_hash, lambda self, v: setattr(self, 'block_hash', v))
        self.pprev = property(lambda self: self.prev, lambda self, v: setattr(self, 'prev', v))
        self.pnext = property(lambda self: self.next, lambda self, v: setattr(self, 'next', v))
        self.nFile = property(lambda self: self.file_num, lambda self, v: setattr(self, 'file_num', v))
        self.nBlockPos = property(lambda self: self.block_pos, lambda self, v: setattr(self, 'block_pos', v))
        self.nHeight = property(lambda self: self.height, lambda self, v: setattr(self, 'height', v))
        self.nVersion = property(lambda self: self.version, lambda self, v: setattr(self, 'version', v))
        self.hashMerkleRoot = property(lambda self: self.merkle_root, lambda self, v: setattr(self, 'merkle_root', v))
        self.nTime = property(lambda self: self.time, lambda self, v: setattr(self, 'time', v))
        self.nBits = property(lambda self: self.bits, lambda self, v: setattr(self, 'bits', v))
        self.nNonce = property(lambda self: self.nonce, lambda self, v: setattr(self, 'nonce', v))
...
class Block:
    ...
    def __init__(self):
        ...
        # Backward compatibility properties
        self.nVersion = property(lambda self: self.version, lambda self, v: setattr(self, 'version', v))
        self.hashPrevBlock = property(lambda self: self.prev_block_hash, lambda self, v: setattr(self, 'prev_block_hash', v))
        self.hashMerkleRoot = property(lambda self: self.merkle_root, lambda self, v: setattr(self, 'merkle_root', v))
        self.nTime = property(lambda self: self.time, lambda self, v: setattr(self, 'time', v))
        self.nBits = property(lambda self: self.bits, lambda self, v: setattr(self, 'bits', v))
        self.nNonce = property(lambda self: self.nonce, lambda self, v: setattr(self, 'nonce', v))
        self.vtx = property(lambda self: self.transactions, lambda self, v: setattr(self, 'transactions', v))
        self.vMerkleTree = property(lambda self: self.merkle_tree, lambda self, v: setattr(self, 'merkle_tree', v))
    ...
    def __str__(self):
        return (f"Block(hash={self.get_hash().get_hex()[:14]}, "
    ...
    def __repr__(self):
        return (f"Block(version={self.version}, height={getattr(self, 'height', '?')}, "
