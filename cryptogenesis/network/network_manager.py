...
class NetworkManager:
    ...
    def start(self, port: int = 8333) -> ServiceResult:
        ...
        with self._lock:
            if self._is_running:
                return ServiceResult(success=False, error="Network is already running")
            ...
            try:
                ...
                return ServiceResult(success=True, data={"port": port, "threads_started": True})
            except Exception as e:
                return ServiceResult(
                    success=False, error=f"Error starting network manager: {str(e)}"
                )
    ...
    def process_received_block(self, block: Block) -> ServiceResult:
        ...
        try:
            ...
            return ServiceResult(success=False, error=f"Exception processing block: {str(e)}")
    ...
    def process_received_transaction(self, tx: Transaction) -> ServiceResult:
        ...
        try:
            ...
            return ServiceResult(success=False, error=f"Exception processing transaction: {str(e)}")
