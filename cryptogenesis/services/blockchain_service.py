...
class BlockchainService:
    ...
    def add_block(self, block: Block) -> ServiceResult:
        ...
        try:
            ...
            if not is_private_network:
                ...
                if not is_valid:
                    return ServiceResult(
                        success=False, error=error_msg or "Block validation failed"
                    )
            ...
            return ServiceResult(success=False, error=f"Exception while adding block: {str(e)}")
    ...
    def load_from_storage(self) -> ServiceResult:
        ...
        try:
            ...
            if best_height < 0:
                return ServiceResult(success=False, error="No blocks found in storage")
