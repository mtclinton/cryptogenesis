...
import sys
import time
from block import Block, BlockIndex, HASH_GENESIS_BLOCK, get_next_work_required
from transaction import Transaction, TxIn, TxOut, Script, COIN
...
def create_genesis_block():
    ...
    # Genesis block timestamp: "The Times 03/Jan/2009 Chancellor on brink of second bailout for banks"
    ...
    # Genesis block pubkey - BigNum('0x...') parses as big-endian, then getvch() reverses to little-endian
    genesis_pubkey_hex = "5F1DF16B2B704C8A578D0BBAF74D385CDE12C11EE50455F3C438EF4C3FBCF649B6DE611FEAE06279A60939E028A8D65C10B73071A6F16719274855FEB0FD8A6704"
    genesis_pubkey_be = bytes.fromhex(genesis_pubkey_hex)  # Big-endian (as in hex string)
    genesis_pubkey_le = bytes(reversed(genesis_pubkey_be))  # Little-endian (after BigNum.getvch() reverse)
